const Navbar = () => {
  return (
    <nav className="w-10/12 mx-auto flex items-center justify-between p-2">
      ...
      <div className="flex items-center gap-6 text-sm font-geist-mono">
        ...
        <button className="rounded-full px-4 py-2 bg-cyan-950 text-white cursor-pointer duration-500 transition hover:bg-cyan-900">
          Get Started
        </button>
      </div>
    </nav>
